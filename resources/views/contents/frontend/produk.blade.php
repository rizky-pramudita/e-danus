    ...
    <div class="row">
        <div class="col-sm-9 mx-auto">
            ...
            <div class="product">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <img src="{{($edit->gambar)}}" class="img-fluid w-100 mb-3">
                    </div>
                    <div class="col-sm-8 detail-produk">
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-4"><b>Tempat</b></div>
                            <div class="col-sm-8"><?= $edit->Tempat_Jual;?></div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-8">
                                <a class="btn btn-success btn-md" 
                                    href="https://api.whatsapp.com/send/?phone={{ $profil_toko->phone }}&text=Halo+ {{ auth()->user()->name }}+ Saya+ ingin+ membeli+ produk +{{url('produk/'.$edit->id)}}+ {{ $edit->Tempat_jual }} +Sejumlah " target="_blank" role="button">
