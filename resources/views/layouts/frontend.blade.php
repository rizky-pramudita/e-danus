    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                ...
                <img src="https://nimpfert.sirv.com/Images/keranjang.png" height="50" alt="" />   
                <b>{{ config('app.name') }}</b>
                    </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <i class="fas fa-envelope-square sm-2"></i> {{ $profil->email }}
                        <br>
                        <i class="fas fa-map-marker-alt sm-2"></i> {{ $profil->address }}
                        <br><br>
                    </div>
                    <div class="col-sm-4">
