...
<form method="post" action="{{ route('admin.update_produk') }}" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="form-group mt-3">
            <label for="">Tempat jual</label>
            <input type="text" class="form-control @error("Tempat_Jual") is-invalid @enderror" value="{{$edit->Tempat_Jual}}" name="Tempat_Jual" id="Tempat_Jual" placeholder="">
        </div>
        <div class="form-group mt-3">
            <label for="">Gambar <small class="text-danger ms-1">* Opsional</small></label>
            <!-- <textarea class="form-control @error("gambar") is-invalid @enderror" value="{{old("gambar")}}" 
