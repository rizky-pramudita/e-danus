                    ...
                    <form method="post" action="{{ route('admin.create_produk') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control @error("Tempat_Jual") is-invalid @enderror" required value="{{old("Tempat_Jual")}}" name="Tempat_Jual" id="Tempat_Jual" placeholder="">
                                @error("Tempat_Jual")
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group mt-3">
                                <label for="">Gambar (Link Https)</label>
